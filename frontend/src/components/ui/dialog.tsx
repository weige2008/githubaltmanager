...
>(({ className, children, hideClose, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 grid max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 gap-4 border bg-card p-6 shadow-lg duration-200 rounded-xl outline-none sm:max-w-lg',
...
// Will be removed after all pages migrate to Radix API in Phase 8
...
// Re-export LegacyDialog as DialogCompat for explicit usage
export { LegacyDialog }
